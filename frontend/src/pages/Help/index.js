				...
				<section id="what-biblecomment">
					<div>
						...
						<p>
							...
							capítulo por dia, para o melhor entendimento da
							palavra de Deus. Uma vez realizado a leitura, por
				...
				<section id="what-comment">
					...
					<div>
						...
						<div>
							...
							Comentário devocional, indica um ensinamento
							extraído do texto, trazendo uma aplicação prática
							para a vida.
						</div>
						<div>
							<input
							...
							Comentário exegético, indica um comentário que é
							necessário estudo da língua original, cultura,
							curiosidades e teólogos.
						</div>
						<div>
							<input
								type="checkbox"
							...
							<img
								...
								alt="personIcon"
							/>
							Comentário pessoal, feito caso o verso tenha tocado
							a pessoa em algum momento na vida, e queira relatar
							para os demais.
						</div>
						<div>
							<input
							...
							Comentário inspirado, indica comentários de algum
							profeta inspirado, canônico ou não.
						</div>
					</div>
				</section>
				<section>
					...
					>
						<ul className="commentaries" style={{ fontSize: 14 }}>
							...
							<div className="user-comment">
								...
								>
									O livro de Gênesis começa com uma verdade
									absoluta que vai de contrário a muitos
									pensamentos da época: <br />
									1 - "No princípio", significa que houve um
									início (a título de exemplo os gregos, anos
									depois, acreditavam que o universo sempre
									existiu, e só foi descoberto que houve um
									início no século XX). <br />
									...
									materialismo, humanismo, deísmo,
									evolucionismo entre outras concepções.
