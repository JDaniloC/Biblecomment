...
const COMMENT_TYPES = [
  ...
  },
  {
    ...
    label: "Pessoal",
    desc: "Um relato de como aquele verso tocou a vida do leitor - uma experiência ou testemunho para edificar os demais.",
  },
  {
    src: "/assets/pen.svg",
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {COMMENT_TYPES.map(({ src, bg, border, label, desc }) => (
            ...
            >
              <div className="w-9 h-9 rounded-full bg-white/70 dark:bg-slate-900/60 flex items-center justify-center shadow-sm">
                <Image src={src} alt={label} width={20} height={20} />
              </div>
              <h3 className="font-semibold text-stone-800 dark:text-stone-100 text-sm">{label}</h3>
