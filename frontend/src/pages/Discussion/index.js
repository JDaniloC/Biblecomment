        ...
        axios
          ...
          .then((response) => {
            if (typeof response.data === "object" && response.data.answers) {
              ...
              const chats = this.state.discussions;
        ...
        <div className={this.state.answersClass}>
          ...
          >
            ...
            <div className="reply-area">
              <div style={{ border: "1px solid #dcdce6", width: "100%" }}>
                <MDEditor
          ...
          {this.props.location.state !== undefined ? (
            <div className={this.state.newPostClass}>
              <div className="top">
                <h1 style={{ alignSelf: "center" }}>Postar novo ponto</h1>
              ...
              <div className="reply-area">
                <div
                  ...
                  style={{ border: "1px solid #dcdce6", width: "100%" }}
                >
                  <MDEditor
                    value={this.state.text}
                    onChange={(evt) => {
