...
export default class Help extends Component {
            ...
            <div className="help-component">
                ...
                <section id="what-biblecomment">
                    <div>
                        ...
                        <p> Um projeto desenvolvido com intuito de ser um meio de ensino e propagação do livro sagrado cristão, através do <b>compartilhamento</b> de comentários e interpretações do mesmo. </p>
                        <p> "[...] Deus nosso Salvador, o qual deseja que todos os homens sejam salvos e cheguem ao pleno conhecimento da verdade." 1 Timóteo 2:3-4 </p>
                        <h2> Como posso participar? </h2>
                        <p> Assim como o projeto <a href="https://reavivadosporsuapalavra.org/"> reavivados por sua palavra</a>, o projeto incentiva a <b>leitura da bíblia</b>, um capítulo por dia, para o melhor entendimento da palavra de Deus. Uma vez realizado a leitura, por vezes será percebido detalhes interessantes para a compreensão do texto bíblico ou lições edificantes para a vida. São esse tipo de comentário ou relato pessoal que é interessante compartilhar. </p>
                    </div>
                    <div>
                    ...
                    <div style= {{ width: "100%", minWidth: "300px" }}>
                        <div className="login-container">
                            <form onSubmit={(evt) => {evt.preventDefault()}} 
                                ...
                                <hr/>   
                                <button style = {{backgroundColor: "rgb(136, 136, 136)"}}>
                                    Login 
                                </button>
                            </form>
                        </div>
                ...
                <section id = "what-comment">
                    <div>
                        ...
                        <p> Não, você pode criar uma conta com o único intuito de <b>participar</b> dos tópicos ou interagir favoritando comentários. </p>
                    </div>
                    <div>
    ...
    O livro de Gênesis começa com uma verdade absoluta que vai de contrário a muitos pensamentos da época: <br/>
    1 - "No princípio", significa que houve um início (a título de exemplo os gregos, anos depois, acreditavam que o universo sempre existiu, e só foi descoberto que houve um início no século XX). <br/>
    2 - "criou", não apenas teve um início, mas veio a existir não pelo acaso divino ou evolucionista, mas por meio de uma criação planejada. <br/>
    3 - "Deus", em contrapartida ao panteísmo essa criação se deu por um único Deus. <br/>
    Por fim, contrário ao deísmo, esse Deus se importa com suas criaturas. <br/>
    Ou seja, vai de contrário ao ateísmo, materialismo, humanismo, deísmo, evolucionismo entre outras concepções. Mostrando o perigo de tentar enquadrar os ensinos bíblicos em sistemas humanos.
                                </p>
                                <span>
                                    <p> Favoritado por <b>10</b> pessoas </p>
                                    <button>
                    ...
                    <div>
                        ...
                        <p> Ele favorita o comentário para que ao logar na conta possa vê-lo diretamente na aba de comentários favoritados em vez de precisar procurar. </p>
                        <h2> Para que serve o botão de chat? </h2>
                        <p> Caso houver alguma discordância em relação a alguma comentário, então o botão cria um novo tópico para que através da orientação do Espírito Santo possamos entender a verdadeira interpretação. </p>
                        <h2> Quando devo reportar um comentário? </h2>
                        <p> Quando o comentário tem o único objetivo de <b>ofender</b>, esteja totalmente desconexo com a realidade do capítulo ou seja apenas interjeições como "amém" </p>
                    </div>
                </section>
            </div>
          </div>
        ...
        <section id="what-comment">
          <div>
            ...
            <p>
              {" "}
              O número de capítulos comentados, comentários selecionados serão
              armazenaos automaticamente. A sua{" "}
        ...
        <section>
            ...
            <ul className="commentaries" style={{ fontSize: 14 }}>
              ...
              <div className="user-comment">
                ...
                >
                  ...
                  1 - "No princípio", significa que houve um início (a título de
                  exemplo os gregos, anos depois, acreditavam que o universo
                  sempre existiu, e só foi descoberto que houve um início no
                  século XX). <br />
                  2 - "criou", não apenas teve um início, mas veio a existir não
                  pelo acaso divino ou evolucionista, mas por meio de uma
                  criação planejada. <br />
                  3 - "Deus", em contrapartida ao panteísmo essa criação se deu
                  por um único Deus. <br />
          ...
          <div>
            ...
            <p>
              {" "}
              Quando o comentário tem o único objetivo de <b>ofender</b>, esteja
              totalmente desconexo com a realidade do capítulo ou seja apenas
              interjeições como "amém"{" "}
            </p>
          </div>
        </section>
      </div>
