		...
		<div className="help-component">
			...
			<section id="what-biblecomment">
				<div>
					...
					<p>
						...
						realizado a leitura, por vezes será percebido detalhes interessantes
						para a compreensão do texto bíblico ou lições edificantes para a
						vida. São esse tipo de comentário ou relato pessoal que é
				...
				<div>
					...
					<p>
						...
						comentários e tópicos levantados pela comunidade. A leitura deve ser
						feita na sua
					...
					<p>
						Divulgando o projeto para amigos e familiares, para que mais pessoas
						sejam edificadas. Encontrando e relatando <b>problemas</b>,
			...
			<section id="what-account">
				<div>
					...
					<p>
						Para o controle de possíveis usuários indesejados e a identificação
						na criação dos comentários e tópicos. Mas o conteúdo é{" "}
			...
			<section id="what-comment">
				<div>
					...
					<p>
						...
						clicar no <b>título</b> do capítulo, no qual representa comentários
						para todo o capítulo.
					</p>
					<h2> Eu preciso comentar? </h2>
					<p>
						Não, você pode criar uma conta com o único intuito de{" "}
						<b>participar</b> dos tópicos ou interagir favoritando comentários.
					</p>
				</div>
				<div>
					...
					<div>
						...
						Comentário inspirado, indica comentários de algum profeta inspirado,
						canônico ou não.
					</div>
				</div>
			</section>
			<section>
					...
					<ul className="commentaries" style={{ fontSize: 14 }}>
						...
						<div className="user-comment">
							...
							>
								...
								uma criação planejada. <br />3 - &quot;Deus&quot;, em
				...
				<div>
					...
					<p>
						...
						então o botão cria um novo tópico para que através da orientação do
						Espírito Santo possamos entender a verdadeira interpretação.
					</p>
