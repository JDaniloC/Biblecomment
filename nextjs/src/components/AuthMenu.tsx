...
export function AuthMenu({ user, loginCallbackUrl }: Props) {
	...
	return (
		<div className="relative flex-shrink-0" data-tour="user-menu">
			...
			>
				<span className="font-bold text-[13px] text-white leading-[13px]">
					{initials}
				</span>
			</button>
			...
			{open && (
				<>
					...
					<div className="absolute right-0 top-11 w-[200px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-[10px] shadow-[0px_8px_30px_0px_rgba(0,0,0,0.14),0px_2px_8px_0px_rgba(0,0,0,0.06)] overflow-hidden z-50">
						<div className="px-4 pt-3 pb-2.5 border-b border-slate-100 dark:border-slate-800">
							...
							<div className="font-normal text-xs text-slate-400 dark:text-slate-500 leading-[18px]">
								@{user.username}
							</div>
						</div>
                ...
                elsewhere on the community page. */}
						...
						>
							...
							<span className="font-medium text-[13px] text-slate-600 dark:text-slate-300 whitespace-nowrap">
								Meu Perfil
							</span>
						</Link>
						<Link
						...
						>
							...
							<span className="font-medium text-[13px] text-slate-600 dark:text-slate-300">
								Configurações
							</span>
						</Link>
						{user.moderator && (
							...
							>
								...
								<span className="font-medium text-[13px] text-amber-700 dark:text-amber-300">
									Moderação
								</span>
							</Link>
						)}
						...
						>
							...
							<span className="font-medium text-[13px] text-red-600 dark:text-red-400">
								Sair
							</span>
						</button>
					</div>
