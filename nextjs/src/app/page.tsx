...
const COMMENT_TYPES = [
	{
		...
		label: "Devocional",
		color:
			"from-amber-50 to-amber-100 dark:from-amber-950/30 dark:to-amber-900/20 border-amber-200 dark:border-amber-900/40",
	...
	},
	{
		...
		label: "Exegético",
		color:
			"from-teal-50 to-teal-100 dark:from-teal-950/30 dark:to-teal-900/20 border-teal-200 dark:border-teal-900/40",
	...
	},
	{
		...
		label: "Pessoal",
		color:
			"from-orange-50 to-orange-100 dark:from-orange-950/30 dark:to-orange-900/20 border-orange-200 dark:border-orange-900/40",
	...
	},
	{
		...
		label: "Inspirado",
		color:
			"from-violet-50 to-violet-100 dark:from-violet-950/30 dark:to-violet-900/20 border-violet-200 dark:border-violet-900/40",
		iconBg: "bg-violet-100 dark:bg-violet-900/30",
		description: "Comentários de algum profeta inspirado, canônico ou não.",
	},
];
				...
				<div className="bg-amber-50 dark:bg-amber-950/20 border-b border-amber-200 dark:border-amber-900/40">
					<div className="max-w-6xl mx-auto px-4 py-2.5">
						<p className="text-sm text-amber-800 dark:text-amber-300 text-center">
							Crie uma conta gratuita para comentar, favoritar versículos e
						...
						<div className="grid md:grid-cols-2 gap-6 md:gap-10 items-start">
							<div className="space-y-4">
								...
								<p className="text-stone-600 dark:text-stone-300 leading-relaxed">
									...
									, incentivamos a leitura da bíblia{" "}
									<strong>um capítulo por dia</strong>. Após a leitura, é comum
									perceber detalhes interessantes ou lições edificantes - é esse
									tipo de comentário que vale a pena compartilhar.
								</p>
								<p className="text-stone-600 dark:text-stone-300 leading-relaxed">
									A leitura deve ser feita na sua{" "}
									<strong>bíblia pessoal</strong>, independente da versão. O
									site serve apenas como espaço para os comentários e tópicos
							...
							<blockquote className="font-lora text-lg md:text-xl italic text-stone-700 dark:text-stone-200 leading-relaxed border-l-4 border-amber-500 dark:border-amber-600 pl-5 py-2">
								&ldquo;[…] Deus nosso Salvador, o qual deseja que todos os
				...
				<section id="tipos" className="px-4 pb-12 md:pb-16 scroll-mt-16">
					<div className="max-w-5xl mx-auto">
						...
						<p className="text-center text-stone-500 dark:text-stone-400 mb-8 max-w-2xl mx-auto">
							Cada comentário pode ser etiquetado com até quatro tipos, ajudando
							a comunidade a entender a perspectiva por trás dele.
						</p>
						...
						<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
							{COMMENT_TYPES.map((t) => (
								...
								>
									<div
										className={`${t.iconBg} w-12 h-12 rounded-xl flex items-center justify-center mb-4`}
									>
