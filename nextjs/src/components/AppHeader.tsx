			...
			<div className="h-full max-w-6xl mx-auto flex items-center px-3 md:px-6 gap-3 md:gap-4">
				...
				>
					...
					<div className="hidden sm:block">
						<div className="font-bold text-[15px] text-slate-800 dark:text-slate-100 leading-[22.5px] whitespace-nowrap">
							BibleComment
						</div>
						<div className="font-light text-[11px] text-[#888] dark:text-slate-400 leading-[16.5px] whitespace-nowrap">
